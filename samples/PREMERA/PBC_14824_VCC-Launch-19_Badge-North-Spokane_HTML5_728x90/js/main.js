...
function initAnimations(){
    ...
    tt
        .set('#badge', {rotation: 25, x: -150, y: -150, transformOrigin: '50% -50%'})

        .to('#badge', 1.5, {rotation: 0, x: 0, y: 0, ease: Power1.easeInOut})
    	.to('#text1_1', 1, {opacity: 1, y: 100, ease: Power1.easeInOut}, "-=1.2")
        .to('#text1_2', 1, {opacity: 1, y: -100, ease: Power1.easeInOut}, "-=1")
        .to('#badge', 0.6, {rotation: 1, x: 0, y: 0, ease: Power1.easeInOut})
        .to('#badge', 0.6, {rotation: 0, x: 0, y: 0, ease: Power1.easeInOut}, "-=0.3")

        .to('#logo', 1, {opacity: 1, ease: Power1.easeInOut}, 0.4, "-=1")

    	.to(['#bg','#badge','#text1_1','#text1_2'], 1, {opacity: 0, ease: Power1.easeInOut}, "+=3")
