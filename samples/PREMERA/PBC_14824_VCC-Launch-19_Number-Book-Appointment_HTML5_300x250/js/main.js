...
function initAnimations(){
    ...
    tt
        ...
        .set('#tag', {rotation: 25, x: 300, y: -300})

        .to('#tag', 1, {rotation: 0, x: 0, y: 0, ease: Power1.easeInOut})
        .staggerTo(['#text1_1','#text1_2','#text1_3','#text1_4','#text1_5','#text1_6','#text1_7'], 1, {opacity: 1, y: 15, ease: Power1.easeInOut}, 0.2, "-=1")

        .to(['#tag','#text1_1','#text1_2','#text1_3','#text1_4','#text1_5','#text1_6','#text1_7'], 1, {opacity: 0, ease: Power1.easeInOut}, "+=2.25")

        .to('#badge', 1.5, {rotation: 0, x: 0, y: 0, ease: Power1.easeInOut})
        .to('#badge', 0.6, {rotation: 2, x: 0, y: 0, ease: Power1.easeInOut}, "-=0.1")
