...
function initAnimations(){
    ...
    tt
    	...
    	.staggerTo(['#text1_1','#text1_2','#text1_3'], 1, {opacity: 1, x: 200, ease: Power1.easeInOut}, 0.4, "-=1")

        .to('#badge', 0.6, {rotation: 1, x: 0, y: 0, ease: Power1.easeInOut}, "-=0.8")
        .to('#badge', 0.6, {rotation: 0, x: 0, y: 0, ease: Power1.easeInOut}, "-=0.2")

    	.to(['#bg','#badge','#text1_1','#text1_2','#text1_3'], 1, {opacity: 0, ease: Power1.easeInOut}, "+=3")
